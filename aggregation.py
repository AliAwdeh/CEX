...
def flatten_conversation_row(
    ...
    row = {
        ...
        "ticket_category": get_md("ticket_category"),
        "model_ticket_category": get_md("ticket_model_category"),
        "ticket_request_origin": get_md("ticket_request_origin"),
        "ticket_category_debug_json": get_md("ticket_category_debug_json"),
